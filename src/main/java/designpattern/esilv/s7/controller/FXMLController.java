...
public class FXMLController implements Initializable {
    ...
    /**
     * display details of selected item in the table
     *
     */
    ...
    /**
     * Enable and disable few buttons in order to sell an item
     *
     */
    ...
    /**
     * Enable and disable few buttons in order to buy an item
     *
     */
    @FXML
    ...
    /**
     * Process in order to buy an item
     *
     */
    @FXML
    ...
    /**
     * Process in order to sell an item
     *
     */
    @FXML
    ...
    /**
     * Process in order load a Json file
     *
     */
    @FXML
    ...
    /**
     * Refresh the stock, pieChart and the barChart
     *
     */
    ...
    /**
     * Return data series of bought items for barChart
     *
     */
    public XYChart.Series<String, Integer> boughtItems() {
        ...
        for (Map.Entry<String, Integer> entry : inv.getBoughtItemsValue().entrySet()) {
    ...
    /**
     * Return data series of sold items for barChart
     *
     */
    public XYChart.Series<String, Integer> soldItems() {
        XYChart.Series<String, Integer> dataSeries1 = new XYChart.Series<>();
        dataSeries1.setName("Number of sold");
        for (Map.Entry<String, Integer> entry : inv.getSoldItemsValue().entrySet()) {
            String date = entry.getKey();
            Integer value = entry.getValue();
            dataSeries1.getData().add(new XYChart.Data(date, value));
    ...
    public void printHistory() throws IOException {
        ...
        Gson gson = new Gson();
        String jsonSold = new Gson().toJson(inv.getSoldItems());
        String jsonBought = gson.toJson(inv.getBoughtItems());
        
        try (PrintWriter out = new PrintWriter("bought_items.json")) {
            out.println(jsonBought);
        }
        
        try (PrintWriter out = new PrintWriter("sold_items.json")) {
            out.println(jsonSold);
        }
    }
}
